            ...
            <div>
                ...
                <div className='p-2 flex-col w-1/2'>
                        <div className='flex justify-between  my-5'>
                            <span className='text-gray-700 text-[1rem] font-bold block'>Profile Information</span>
                        ...
                        <div className=''>
                            <p className='text-md text-gray-400 pr-1 '>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ducimus possimus, incidunt temporibus voluptas suscipit libero tempora aliquam fugiat recusandae accusantium rem dignissimos pariatur quo laudantium neque delectus, aperiam, tenetur vitae.</p>
                        </div>
                        <div className='mt-8'>
                            <table>
                                <tc className="text-sm  text-gray-700 font-bold p-1 mr-3"> 
                                    <tc>
                                    <tr className='w-auto'>
                                        <td>Full Name: </td>
                                    </tr>
                                ...
                                <tc className="text-sm  font-semibold text-gray-600 ">
                                   <tc>
                                    <tr>
                                        <td>{data ? data.user.full_name : "user name"}</td>
                                    </tr>
                                    </tc>
                                </tc>
                            </table>
